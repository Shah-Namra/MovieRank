...
//         </motion.div>
//         <motion.p
//           className="text-lg font-semibold text-slate-900/80"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
...
export function LoadingState() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-8">
      ...
      >
        <div className="w-14 h-14 rounded-full border-[3px] border-muted border-t-foreground" />
      </motion.div>
  ...
  return (
    <div className="space-y-3">
      {[...Array(count)].map((_, i) => (
        ...
        >
          <div className="w-12 h-16 rounded-lg bg-muted animate-pulse" />
          <div className="flex-1 space-y-2">
